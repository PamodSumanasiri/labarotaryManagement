...
<head>
    ...
    <style>
        ...
        .btn-primary-soft2{
            ...
            /*border: 1px solid rgba(57,108,240,0.1) ;*/    color: #ffffff;
            font-weight: 500;
            font-size: 16px;
            border: none;
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <a href="./paymentGateway" ><button  class="login-btn btn-primary-soft2 btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Pay Now</font></button></a>
