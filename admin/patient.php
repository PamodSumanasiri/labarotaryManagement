...
<head>
    ...
    <style>
        body {
            background-color: #ffffff; /* Change this value to the desired color */
        }
        .login-btn {
            background-color:#FFFF00; /* Change this value to set the background color of primary buttons */
            color: #007bff; /* Change this value to set the text color of primary buttons */
        }
        .popup{
